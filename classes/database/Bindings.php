...
class Bindings
{
    ...
    function generate()
    {
        ...
        if ($this->converter::class == "Converter\NewClient") {
        ...
        } elseif ($this->converter::class == "Converter\UpdateIdentifiableIn") {
            $this->binding = [
                'iss',
                $arr["ref_in"],
                $arr["code"],
        ...
        } elseif ($this->converter::class == "Converter\UpdateIdentifiableOut") {
            $this->binding = [
                'iss',
                $arr["ref_out"],
                $arr["code"],
            ...
            $this->binding = [
                'i',
                $this->converter->data_for_db["num_avoir"]
            ];
