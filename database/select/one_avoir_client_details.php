...
use Converter\SelectOneAvoirClient;
...
if (($_SERVER["REQUEST_METHOD"] == "POST") && (can_visit("avoir_client"))) {
    // if (\true) {
    $data = json_decode(file_get_contents('php://input'), true);
    // var_dump($data);

    $SelectOneObj = new SelectOneAvoirClient($data);
    // var_dump($NewClientObj);
    $Query = new Queries("select_one_avoir_client");
