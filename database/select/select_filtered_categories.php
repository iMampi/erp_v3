...
use Converter\FilterCategories;
...
if (($_SERVER["REQUEST_METHOD"] == "POST") && (can_visit("client"))) {
    ...
    $FilterCategorieObj = new FilterCategories($data);
    // var_dump($NewClientObj);
    $Query = new Queries("filter_categories");
    $myquery = $Query->query . $FilterCategorieObj->conditions;
