...
if (($_SERVER["REQUEST_METHOD"] == "POST") && (can_create("categorie"))) {
    $data = json_decode(file_get_contents('php://input'), true);
    // var_dump($data);
    // echo 'here we are';
    $NewConverterObj = new NewCategorie($data);
    // var_dump($NewClientObj);
    $Query = new Queries("save_new_categorie");
