...
<body class="bg-g">
    <div id="main-container" class="container-fluid px-0">
        <div id="header-top" class=" bg-light-blue">
            ...
            ">
                <div class="px-5">
                    ...
                    if (!can_visit("facture_client")) {
                        ...
                        require_once $_SERVER["DOCUMENT_ROOT"] . '/elements/sub_header_facts_clt.html';
            ...
            <div class="modal fade" id="modal-facture-details" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div id="modal-body-heads">
                                ...
                                require_once __DIR__ . "/../elements/facts_clt/facture_clt_header_base_disabled.html";
                                ?>
                            </div>
                            <!-- TODO : to elete. we gonna use only JS here -->
                            <div id="modal-body-table">
                                <?php
                                require_once __DIR__ . "/../elements/facts_clt/facture_clt_table_details_base_disabled.html";
                                ?>
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-between">
                            ...
                            require_once __DIR__ .
                                "/../modals_processors/btns_footer_v1.php";
            ...
            <!-- modal creer facture client -->
            <div class="modal fade" id="modal-facture-new" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <button type="button" class="btn-close position-absolute top-0 end-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">création facture client</h5>
                        </div>
                        <div class="modal-body">
            ...
            <!-- end modal creer facture client -->
            <!-- modal creer item -->
